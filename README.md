# Adicionando Segurança em API's na AWS com Amazon Cognito - Bootcamp AWS Dio
...
- Protocol - REST -> Create new API -> API name [dio_api] -> Endpoint Type - Regional -> Create API
